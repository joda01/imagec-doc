$(document).ready(function(){
	...
	if( $('.hamburger').is(':visible') ){
		var animationpath = "/js/imagecanimation_search.json"
	} else {
		var animationpath = "/js/imagecanimation.json"
	}
	let imageCicon = document.getElementById('imagecanimation');	
    let animationimageCicon = lottie.loadAnimation({
            container: imageCicon,
            renderer: 'svg',
            loop: false,
            autoplay: false,
            path: animationpath
	...
	if( !$('.hamburger').is(':visible') ){
		$('#imagecanimation, .imagechome img.downloadlogo').mouseenter(function() {
			animationimageCicon.play();
			animationimageCicon.setDirection(1)
		})
		$('#imagecanimation, .imagechome img.downloadlogo').mouseleave(function() {
			animationimageCicon.play();
			animationimageCicon.setDirection(-1)
		})
	}
