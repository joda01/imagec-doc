...
# Modify the content of a file: replace "https://imagec.org" in all files,
...
def modify_file(file_path):
    try:
        ...
        # Replace "https://imagec.org" with `"` in all files
        content_updated = content.replace('"https://imagec.org', '"')
...
if __name__ == "__main__":
    root_directory = r"./imagec-doc"  # Define imagec-doc directory
